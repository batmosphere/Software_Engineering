...
session_start();
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($payment !== "Cab Sharing")
      {
                    ...
                    $sql7 = "INSERT into payment ( mode_of_payment, amount) VALUES ('$payment', '$totalprice') ;";
                    $result7 = mysqli_query($db,$sql7);

                    // echo "$result7";


                    $sql5 = "INSERT into trip (username, driver_id, driver_first, driver_last, source, destination) VALUES ('$user_check','$ID','$First_Name','$Last_Name','$source','$destination')";
      ...
      //               $sql5 = "INSERT into trip values($new_T,'$user_check','$ID',NULL,NULL,'$source','$destination',0,0,'$registration_number','$distance',0,0);";
      //               $result5 = mysqli_query($db,$sql5);
      ...
      //                   $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
      //                   $car_reg = $row['car_reg'];
      //                   $_SESSION['registration_number'] = $car_reg;
